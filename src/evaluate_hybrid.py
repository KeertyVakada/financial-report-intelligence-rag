...
def evaluate_question(question: dict) -> dict:
    """Evaluate hybrid retrieval for one question."""
...
def main():
    """Run complete hybrid retrieval evaluation."""

    print("=" * 80)
    print(
        "HYBRID FINANCIAL REPORT RETRIEVAL EVALUATION"
    )
    print("=" * 80)
