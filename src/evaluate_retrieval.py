...
def evaluate_question(question: dict) -> dict:
    """Evaluate retrieval performance for one question."""
...
def print_result(result: dict) -> None:
    """Print evaluation result for one question."""
    ...
    if not result["expected_chunks"]:
        ...
        print(
            "No expected document chunk. "
            "Used to inspect retrieval confidence."
        )
...
def main():
    ...
    print("=" * 80)
    print("FINANCIAL REPORT RETRIEVAL EVALUATION")
    print("=" * 80)
    ...
    # Only document questions are used for retrieval metrics.
    document_questions = [
        result
        for result in results
    ...
    if out_of_document_questions:
        ...
        print(
            "\nTop scores for out-of-document questions:"
        )
